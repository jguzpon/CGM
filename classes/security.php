...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "tik_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getTableDataSource( "tik_ugmembers", $cman->getUserGroupsConnId() );
	}	
}
?>