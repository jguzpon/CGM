...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("tik_chatau" == $this->chrt_array['tables'][0])
			return true;
		if("tik_autorizadores" == $this->chrt_array['tables'][0])
			return true;
		if("tik_firmash" == $this->chrt_array['tables'][0])
			return true;
		if("tik_chat" == $this->chrt_array['tables'][0])
			return true;
		...
		if("tik_memorando_l" == $this->chrt_array['tables'][0])
			return true;
		if("tik_firmas" == $this->chrt_array['tables'][0])
			return true;
		if("tik_memorando" == $this->chrt_array['tables'][0])
			return true;
		if("zmeses" == $this->chrt_array['tables'][0])
			return true;
		if("zusuarios" == $this->chrt_array['tables'][0])
			return true;
		if("tik_tablas" == $this->chrt_array['tables'][0])
			return true;
		if("tik_satisfaccion" == $this->chrt_array['tables'][0])
			return true;
		if("tik_interno" == $this->chrt_array['tables'][0])
			return true;
		if("tik_documento" == $this->chrt_array['tables'][0])
			return true;
		if("tik_restulado" == $this->chrt_array['tables'][0])
			return true;
		if("zusuarios" == $this->chrt_array['tables'][0])
			return true;
		if("tik_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("zusuarios" == $this->chrt_array['tables'][0])
			return true;
		if("zusuarios" == $this->chrt_array['tables'][0])
			return true;
		if("tik_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tik_calendario" == $this->chrt_array['tables'][0])
			return true;
		if("zdepartamentos" == $this->chrt_array['tables'][0])
			return true;
		if("tik_audit" == $this->chrt_array['tables'][0])
			return true;
		if("tik_interno" == $this->chrt_array['tables'][0])
			return true;
		if("tik_interno" == $this->chrt_array['tables'][0])
		...
		if("tik_interno" == $this->chrt_array['tables'][0])
			return true;
		if("tik_cfg" == $this->chrt_array['tables'][0])
			return true;
		if("tik_interno" == $this->chrt_array['tables'][0])
			return true;
		if("tik_tipomemo" == $this->chrt_array['tables'][0])
			return true;
		if("tik_memorando_aut_otrdep" == $this->chrt_array['tables'][0])
			return true;
		if("tik_interno" == $this->chrt_array['tables'][0])
			return true;
		return false;
