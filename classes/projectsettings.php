...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("zusuarios", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "MPCChat" ] = array( "url" => "mpcchat", "type" => 4 );
	$projectEntitiesReverse[ "mpcchat" ] = "MPCChat";
	$projectEntities[ "tik_chatau" ] = array( "url" => "tik_chatau", "type" => 0 );
	$projectEntitiesReverse[ "tik_chatau" ] = "tik_chatau";
	$projectEntities[ "tik_autorizadores" ] = array( "url" => "tik_autorizadores", "type" => 0 );
	$projectEntitiesReverse[ "tik_autorizadores" ] = "tik_autorizadores";
	$projectEntities[ "tik_firmash" ] = array( "url" => "tik_firmash", "type" => 0 );
	$projectEntitiesReverse[ "tik_firmash" ] = "tik_firmash";
	$projectEntities[ "tik_chat" ] = array( "url" => "tik_chat", "type" => 0 );
	...
	$projectEntitiesReverse[ "tik_memorando_l" ] = "tik_memorando_l";
	$projectEntities[ "tik_firmas" ] = array( "url" => "tik_firmas", "type" => 0 );
	$projectEntitiesReverse[ "tik_firmas" ] = "tik_firmas";
	$projectEntities[ "tik_memorando" ] = array( "url" => "tik_memorando", "type" => 0 );
	$projectEntitiesReverse[ "tik_memorando" ] = "tik_memorando";
	$projectEntities[ "zmeses" ] = array( "url" => "zmeses", "type" => 0 );
	$projectEntitiesReverse[ "zmeses" ] = "zmeses";
	$projectEntities[ "v_zusuarios" ] = array( "url" => "v_zusuarios", "type" => 1 );
	$projectEntitiesReverse[ "v_zusuarios" ] = "v_zusuarios";
	$projectEntities[ "tik_tablas" ] = array( "url" => "tik_tablas", "type" => 0 );
	$projectEntitiesReverse[ "tik_tablas" ] = "tik_tablas";
	$projectEntities[ "tik_satisfaccion" ] = array( "url" => "tik_satisfaccion", "type" => 0 );
	$projectEntitiesReverse[ "tik_satisfaccion" ] = "tik_satisfaccion";
	$projectEntities[ "tik_interno" ] = array( "url" => "tik_interno", "type" => 0 );
	$projectEntitiesReverse[ "tik_interno" ] = "tik_interno";
	$projectEntities[ "tik_documento" ] = array( "url" => "tik_documento", "type" => 0 );
	$projectEntitiesReverse[ "tik_documento" ] = "tik_documento";
	$projectEntities[ "tik_restulado" ] = array( "url" => "tik_restulado", "type" => 0 );
	$projectEntitiesReverse[ "tik_restulado" ] = "tik_restulado";
	$projectEntities[ "zusuarios" ] = array( "url" => "zusuarios", "type" => 0 );
	$projectEntitiesReverse[ "zusuarios" ] = "zusuarios";
	...
	$projectEntities[ "tik_tipo" ] = array( "url" => "tik_tipo", "type" => 0 );
	$projectEntitiesReverse[ "tik_tipo" ] = "tik_tipo";
	$projectEntities[ "tik_calendario" ] = array( "url" => "tik_calendario", "type" => 0 );
	$projectEntitiesReverse[ "tik_calendario" ] = "tik_calendario";
	$projectEntities[ "zdepartamentos" ] = array( "url" => "zdepartamentos", "type" => 0 );
	$projectEntitiesReverse[ "zdepartamentos" ] = "zdepartamentos";
	$projectEntities[ "tik_audit" ] = array( "url" => "tik_audit", "type" => 0 );
	$projectEntitiesReverse[ "tik_audit" ] = "tik_audit";
	$projectEntities[ "vtik_interno" ] = array( "url" => "vtik_interno", "type" => 1 );
	$projectEntitiesReverse[ "vtik_interno" ] = "vtik_interno";
	$projectEntities[ "Control de Asistencias" ] = array( "url" => "control_de_asistencias", "type" => 2 );
	$projectEntitiesReverse[ "control_de_asistencias" ] = "Control de Asistencias";
	$projectEntities[ "Gráfico de Asistencias" ] = array( "url" => "gr_fico_de_asistencias", "type" => 3 );
	$projectEntitiesReverse[ "gr_fico_de_asistencias" ] = "Gráfico de Asistencias";
	$projectEntities[ "Pendientes por Departamento" ] = array( "url" => "pendientes_por_departamento", "type" => 2 );
	$projectEntitiesReverse[ "pendientes_por_departamento" ] = "Pendientes por Departamento";
	$projectEntities[ "tik_cfg" ] = array( "url" => "tik_cfg", "type" => 0 );
	$projectEntitiesReverse[ "tik_cfg" ] = "tik_cfg";
	$projectEntities[ "Asistencias Realizadas por Fecha" ] = array( "url" => "asistencias_realizadas_por_fecha", "type" => 2 );
	$projectEntitiesReverse[ "asistencias_realizadas_por_fecha" ] = "Asistencias Realizadas por Fecha";
	$projectEntities[ "tik_tipomemo" ] = array( "url" => "tik_tipomemo", "type" => 0 );
	...
	$projectEntities[ "vtik_memorando_hist" ] = array( "url" => "vtik_memorando_hist", "type" => 1 );
	$projectEntitiesReverse[ "vtik_memorando_hist" ] = "vtik_memorando_hist";
}
