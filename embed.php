...
<!--                <label for="UploadMovieFile">
            ...
            <div style="padding-top: 3px">
                <div id="pre_saved_buttons" style="display:none">
                   <a href="#" class="rnr-button" id="RemovePrevSnapshot" onClick="remove_previous_snapshot();return false;">Remove Snapshot</a>
		</div>
                <div id="pre_take_buttons" style="display:none">
                   <a href="#" class="rnr-button" id="TakeSnapshot" onClick="SnapshotCamFile[0]['name'] = '';init_snapshotcam(false,true,false,true);setTimeout('save_photo()',500);return false;">Take Snapshot</a>
		</div>
		<div id="post_take_buttons" style="display:none">
            		<a href="#" class="rnr-button" id="CancelPreview" onClick="SnapshotCamFile[0]['name'] = '';init_snapshotcam(true,false,false,false);return false;"></a>
			<a href="#" class="rnr-button" id="SavePhoto" onClick="save_photo();return false;"></a>
		</div>
            </div>
            <br/>
            <div id="config_html5_camera">
                <div class="select">
                    <div id="div_camera_config" style="display:none">
                        ...
                        <br/>
                        <div>
                            <a href="#" class="rnr-button" id="SavePhoto" onclick="configure_cam();return false;">SnapshotCam Configuration Close</a>
                        </div>
                      </div>
                </div>
            </div>
