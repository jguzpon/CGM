...
$tdataadmin_rights[".OriginalTable"] = "tik_ugrights";


$tdataadmin_rights[".pagesByType"] = my_json_decode( "{\"search\":[\"search\"]}" );
$tdataadmin_rights[".originalPagesByType"] = $tdataadmin_rights[".pagesByType"];
$tdataadmin_rights[".pages"] = types2pages( my_json_decode( "{\"search\":[\"search\"]}" ) );
$tdataadmin_rights[".originalPages"] = $tdataadmin_rights[".pages"];
$tdataadmin_rights[".defaultPages"] = my_json_decode( "{\"search\":\"search\"}" );
...
$tdataadmin_rights[".connId"] = "mpc_at_localhost";


$tdataadmin_rights[".strOriginalTableName"] = "tik_ugrights";
...
$tdataadmin_rights[".afterAddAction"] = 0;
...
$tdataadmin_rights[".sqlFrom"] = "FROM tik_ugrights";
...
$proto0["m_strFrom"] = "FROM tik_ugrights";
$proto0["m_strWhere"] = "";
$proto0["m_strOrderBy"] = "";
...
$proto14["m_link"] = "SQLL_MAIN";
			$proto15=array();
$proto15["m_strName"] = "tik_ugrights";
