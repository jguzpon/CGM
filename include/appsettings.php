...
$twilioSID = "SKee04880fd38cc718dc819623d80fe9b6";
$twilioAuth = "7452700e9803782507c4b36625888369";
$twilioNumber = "+14079794104";
...
$globalSettings["strSMTPUser"] = "prueba@ampuertocortes.hn";
$globalSettings["strSMTPServer"] = "mail.ampuertocortes.hn";
$globalSettings["strSMTPPort"] = "587";
$globalSettings["strSMTPPassword"] = "S0l0P4r43nl4c3DIT";
$globalSettings["strFromEmail"] = "prueba@ampuertocortes.hn";
...
$globalSettings["ProjectLogo"]["Spanish"] = "CGM";
...
$globalSettings["usersDatasourceTable"] = "zusuarios";

$globalSettings["jwtSecret"] = "KnDhuKjb39zbkOFLck15";
...
$projectBuildKey = "365_1621302189";
$wizardBuildKey = "35214";
$projectBuildNumber = "365";
...
$tableCaptions["Spanish"]["tik_chatau"] = "Usuarios Chat";
$tableCaptions["Spanish"]["tik_autorizadores"] = "Autorizadores Digitales";
...
$tableCaptions["Spanish"]["tik_memorando"] = "Memorando Digital";
$tableCaptions["Spanish"]["zmeses"] = "Meses";
$tableCaptions["Spanish"]["v_zusuarios"] = "Usuarios";
$tableCaptions["Spanish"]["tik_tablas"] = "Tablas Generales";
$tableCaptions["Spanish"]["tik_satisfaccion"] = "Tabla de Satisfaccion";
$tableCaptions["Spanish"]["tik_interno"] = "Solicitudes Internas";
$tableCaptions["Spanish"]["tik_documento"] = "Documentos";
$tableCaptions["Spanish"]["tik_restulado"] = "Restulados";
$tableCaptions["Spanish"]["zusuarios"] = "Usuarios";
...
$tableCaptions["Spanish"]["tik_tipo"] = "Tipo Solicitudes";
$tableCaptions["Spanish"]["tik_calendario"] = "Calendario";
$tableCaptions["Spanish"]["zdepartamentos"] = "Departamentos";
$tableCaptions["Spanish"]["tik_audit"] = "Control de Auditoría";
$tableCaptions["Spanish"]["vtik_interno"] = "Solicitudes Internas Pendientes";
$tableCaptions["Spanish"]["Control_de_Asistencias"] = "Control de Asistencias";
$tableCaptions["Spanish"]["Gr_fico_de_Asistencias"] = "Gráfico de Asistencias";
$tableCaptions["Spanish"]["Pendientes_por_Departamento"] = "Pendientes por Departamento";
$tableCaptions["Spanish"]["tik_cfg"] = "Configuración";
$tableCaptions["Spanish"]["Asistencias_Realizadas_por_Fecha"] = "Asistencias Realizadas por Fecha";
...
$tableCaptions["Spanish"]["vtik_memorando_hist"] = "Memorando Históricos";
...
fwrite($salida,"sql".$strSQLExists.PHP_EOL);
fclose($salida); */

// Procesar y verificar si ya se procesaron los registros de solicitudes para verificar cuales están vencidos
/*
$hoy = strftime("%Y-%m-%d %H:%M:%S");
$fp = DBLookup("select FechaProceso from tik_cfg where Codigo = 1");
if( $hoy > $fp ) {
	// Actualizar informacion de proceso
	$hoym1h = addHoras($hoy,1);
	$data = array();
	$data["FechaProceso"] = $hoym1h;
	DB::Update("tik_cfg", $data, "Codigo=1");
	// Obtener dias habiles a sumar
	$dh = DBLookup("select ControlDiasHabiles from tik_cfg where Codigo = 1");
	// Buscar todos las solicitudes pendientes
	$sqa = "select * from tik_interno a where Estado = 'Pendiente'";
	$ra = CustomQuery($sqa);
	while( $da = db_fetch_array($ra) ) {
		$dias3 = addDias($da["FechaSolicitud"],$dh,'H');
		if( $hoy >= $dias3 ) {
			// Cerrar solicitud y actualizar insatisfaccion de solicitud
			$data["Estado"] = 'Evaluado';
			$data["Evaluacion"] = 1;
			$data["Observaciones"] = 'LA SOLICITUD INTERNA FUE CERRADA POR INCUMPLIMIENTO DEL TIEMPO DE RESPUESTA';
			$keyvalues["Solicitud"] = $da["Solicitud"];
			DB::Update("tik_interno", $data, $keyvalues);
		}
	}
}
*/
